...
use crate::http::model::{CustomEmoji, ids::*, ImageFormat, StillImage, voice::VoiceState};
...
impl Guild {
    ...
    /// ([GuildFeature::Discoverable] must be one of the guild's [features](Guild::features)). The
